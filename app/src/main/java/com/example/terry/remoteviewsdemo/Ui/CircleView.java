package com.example.terry.remoteviewsdemo.Ui;
...
import com.example.terry.remoteviewsdemo.R;
...
public class CircleView extends View {
    ...
    public CircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColor = a.getColor(R.styleable.CircleView_circle_color, Color.MAGENTA);
        a.recycle();
        init();
    }
